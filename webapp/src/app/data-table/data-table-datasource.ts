 ...
 */
export class DataTableDataSource extends DataSource<Problem> {
  data: Problem[] = [];
  ...
  connect(): Observable<Problem[]> {
    // this.problemService.getProblems().subscribe(problem => this.data = problem)
   ...
   */
  private getPagedData(data: Problem[]): Problem[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: Problem[]): Problem[] {
